...
export const AuditLogsDrawer: React.FC<AuditLogsDrawerProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Slide-out Panel */}
      <div
        className={`fixed top-0 right-0 h-full w-[420px] max-w-full bg-bg-card border-l border-border-primary shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col text-text-primary ${
