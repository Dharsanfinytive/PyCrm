...
export const DirectPlacement: React.FC = () => {
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-8 space-y-8 fade-in">
      ...
      <div className="silver-gradient-panel flex flex-col justify-between gap-4 rounded-[28px] p-6 sm:flex-row sm:items-center">
        <div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            onClick={triggerSync}
            disabled={isSyncing}
            className="silver-button-secondary flex items-center gap-1.5 rounded-lg px-3.5 py-2 text-xs font-semibold active:scale-95"
          >
          ...
          <button
            onClick={triggerSync}
            className="silver-button-secondary rounded-lg px-3.5 py-2 text-xs font-semibold active:scale-95"
          >
            Refresh
          </button>
          ...
          {currentUser.role !== 'FINANCE' && (
            <button
              ...
              className="silver-button-primary flex items-center gap-1.5 rounded-lg px-4 py-2.5 text-xs font-bold uppercase tracking-wider active:scale-95"
            >
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div className="silver-card flex items-center gap-4 rounded-2xl p-5">
          <div className="rounded-xl bg-indigo-50 p-3 text-indigo-600"><Users className="h-5 w-5" /></div>
          <div>
        ...
        <div className="silver-card flex items-center gap-4 rounded-2xl p-5">
          <div className="rounded-xl bg-emerald-50 p-3 text-emerald-600"><IndianRupee className="h-5 w-5" /></div>
          <div>
            <div className="text-[10px] font-bold font-mono uppercase tracking-wider text-text-muted">Revenue Received</div>
            <div className="text-2xl font-bold text-emerald-600">₹{revenueSum.toLocaleString()}</div>
          </div>
        </div>

        <div className="silver-card flex items-center gap-4 rounded-2xl p-5">
          <div className="rounded-xl bg-rose-50 p-3 text-rose-500"><IndianRupee className="h-5 w-5" /></div>
          <div>
            <div className="text-[10px] font-bold font-mono uppercase tracking-wider text-text-muted">Pending Dues</div>
            <div className="text-2xl font-bold text-rose-500">₹{duesSum.toLocaleString()}</div>
          </div>
        </div>
      ...
      <div className="silver-gradient-panel rounded-[26px] p-5 space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 bg-white/80 text-sm text-slate-700 shadow-inner outline-none transition focus:border-indigo-400 focus:ring-4 focus:ring-indigo-500/10"
          />
        </div>
      ...
      <div className="space-y-3">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {filteredDP.map(candidate => {
            ...
            return (
              <div
                ...
                className="silver-card flex cursor-pointer items-center justify-between gap-3 rounded-2xl p-4 transition-all duration-200 hover:-translate-y-1 hover:border-indigo-200 hover:shadow-[0_18px_35px_rgba(79,70,229,0.12)]"
              >
          ...
          {filteredDP.length === 0 && (
            <div className="col-span-full rounded-2xl border border-dashed border-border-primary p-8 text-center text-text-muted text-xs">
      ...
      <div className="silver-gradient-panel rounded-[26px] p-6 space-y-4">
        <h3 className="font-bold text-lg uppercase tracking-wide text-text-secondary">
          System Change Log
        </h3>
        <div className="divide-y divide-border-secondary overflow-hidden rounded-xl border border-border-primary bg-white/40">
