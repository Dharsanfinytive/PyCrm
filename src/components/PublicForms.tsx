          ...
          {(activeFormType === 'BGV' || activeFormType === 'DP_BGV') && (
            <form onSubmit={(e) => handleBgvSubmit(e, activeFormType === 'DP_BGV')} className="space-y-4 text-xs">
              ...
              <div className="space-y-2">
                ...
                <div className="border border-dashed border-border-primary hover:border-accent-orange/45 rounded-xl p-4 text-center cursor-pointer transition-all bg-bg-secondary/25">
